...
data <- read.table("03data/2022-11-23scraped_articles.txt", header=TRUE, na.strings="NA")
...
# save
write.table(data_nomissing, paste0("03data/", Sys.Date(), "data_wrangled.txt"), row.names = FALSE)
...
write.table(data_per_article, 
            paste0("03data/", Sys.Date(), "data_per_article.txt"), row.names = FALSE)
