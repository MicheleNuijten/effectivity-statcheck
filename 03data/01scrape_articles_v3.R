...
source("03data/00extract_dates_v2.R")
...
write.table(final_result, paste0("03data/", Sys.Date(), "scraped_articles_v3.txt"))


# Warning messages:
# 1: In readChar(con, file.info(fileName)$size, useBytes = TRUE) :
#    truncating string with embedded nuls
# 2: In readChar(con, file.info(fileName)$size, useBytes = TRUE) :
#    truncating string with embedded nuls
# 3: In readChar(con, file.info(fileName)$size, useBytes = TRUE) :
#    truncating string with embedded nuls
