...
# load packages
devtools::install_github("MicheleNuijten/statcheck@v1.4.1-beta.2")
library(statcheck)

# source helper functions 
source("03data/00extract_pattern.R")
source("03data/00extract_dates.R")
source("03data/00html_to_txt_v2.R")
...
write.table(final_result, paste0("03data/", Sys.Date(), "scraped_articles_v2.txt"))
...
# 7: All formats failed to parse. No formats found.
# 8: All formats failed to parse. No formats found.
# 9: All formats failed to parse. No formats found.
# 10: All formats failed to parse. No formats found.
# 11: In readChar(con, file.info(fileName)$size, useBytes = TRUE) :
#   truncating string with embedded nuls
# 12: In readChar(con, file.info(fileName)$size, useBytes = TRUE) :
#   truncating string with embedded nuls
# 13: In readChar(con, file.info(fileName)$size, useBytes = TRUE) :
#   truncating string with embedded nuls
# 14: All formats failed to parse. No formats found.
